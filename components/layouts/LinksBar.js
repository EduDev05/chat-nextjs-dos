    ...
    <>
      ...
      >
        <StyledBadge
          ...
          variant="dot"
        >
          {/* <img src='https://stg0chbot0tec0prod.blob.core.windows.net/bot-imagen/BotImage.png' style={ {width: 50, height: 50} } /> */}
          <Avatar src="./public/avatar" sx={{ width: 50, height: 50 }} /> 
        </StyledBadge>
      </Box>
      ...
      >
        <Box flex flexDirection="column">
          ...
          <a
            ...
            //href="https://stg0chbot0tec0prod.blob.core.windows.net/bot-imagen/BotImage.png"
            //https://stg0chbot0tec0prod.blob.core.windows.net/bot-imagen/BotImage.png'
            target="_blank"
            rel="noreferrer"
          >
